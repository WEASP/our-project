...
import com.zhifou.dao.QuestionDAO;
import com.zhifou.dao.UserDAO;
import com.zhifou.model.EntityType;
import com.zhifou.model.Question;
import com.zhifou.model.User;
import com.zhifou.service.FollowService;
import com.zhifou.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.zhifou.com/head/%dt.png", random.nextInt(1000)));
