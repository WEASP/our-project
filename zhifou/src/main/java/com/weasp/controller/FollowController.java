...
/**
 * Created by JackHui on 2017/6/17.
 */
@Controller
public class FollowController {
    ...
    public String followUser(@RequestParam("userId") int userId) {
        ...
        // 返回关注的人数
        return ZhifouUtil.getJSONString(ret ? 0 : 1, String.valueOf(followService.getFolloweeCount(hostHolder.getUser().getId(), EntityType.ENTITY_USER)));
    }
    ...
    public String followQuestion(@RequestParam("questionId") int questionId) {
        ...
        return ZhifouUtil.getJSONString(ret ? 0 : 1, info);
    }
